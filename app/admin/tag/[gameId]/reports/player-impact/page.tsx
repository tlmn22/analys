...
import { PlayerImpactClient } from "./player-impact-client";

export const dynamic = "force-dynamic";

export default async function PlayerImpactPage({
  params,
}: {
      ...
      <div className="mx-auto max-w-[1600px]">
        ...
        <div className="mt-3">
          <ReportHeader
            ...
            title="On/Off Player Impact"
            activeSlug="player-impact"
            info={info}
          />
        </div>
        <p className="mt-4 text-center text-sm italic text-muted-foreground">
          See how each player, pair, or group of three affects team stats when on or off the floor.
        </p>
