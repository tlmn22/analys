...
import { PlayerLineupStatsClient } from "./player-lineup-stats-client";

export const dynamic = "force-dynamic";

export default async function PlayerLineupStatsPage({
  params,
}: {
      ...
      <div className="mx-auto max-w-[1600px]">
        ...
        <div className="mt-3">
          <ReportHeader
            ...
            title="Player Stats"
            activeSlug="player-lineup-stats"
            info={info}
          />
        </div>

        <div className="mt-8">
          <PlayerLineupStatsClient
