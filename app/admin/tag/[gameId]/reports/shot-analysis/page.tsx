...
import { ShotAnalysisClient } from "./shot-analysis-client";

export const dynamic = "force-dynamic";

export default async function ShotAnalysisPage({
  params,
}: {
    ...
    <div className="min-h-screen bg-background p-6 text-foreground">
      <div className="mx-auto max-w-[1600px]">
        ...
        <div className="mt-3">
          <ReportHeader
            gameId={gameId}
            icon={<FlaskConicalIcon className="size-7" />}
            title="Shot Analysis"
            activeSlug="shot-analysis"
            info={info}
          />
        </div>
